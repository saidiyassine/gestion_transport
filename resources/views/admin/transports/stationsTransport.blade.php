    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Liste des transports pour voir l'ordre des stations de chaque transport</h3>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ url('admin/stations/listStations') }}">
                    ...
                    <button type="submit" class="btn btn-primary mt-2">Consulter</button>
                </form>
            </div>
        </div>
    </div>
